...
class BYOL(nn.Module):
    ...
    def forward(self, image_one, image_two, return_embedding = False):
        if return_embedding:
            return self.online_encoder(image_one) # , return_embedding = True

        online_proj_one,representation1 = self.online_encoder(image_one)
        online_proj_two,representation2 = self.online_encoder(image_two)
        ...
        return representation1, representation2, loss.mean()
