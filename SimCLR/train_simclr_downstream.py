...
if dataset == 'gtsrb':
    data_set = torchvision.datasets.ImageFolder(root="/home/lipan/LiPan/dataset/" + dataset + '/test')
    n_classes = 43
...
BASE_MODEL = 'simclr-encoder-poison.pth'
print(BASE_MODEL,'!!!!!!!!!!!!!!!!!!!!!')
...
for epoch in range(start_epoch, start_epoch + epochs):
    ...
    if epoch%9==0:
        torch.save(net.state_dict(), f"results/simclr-downstream.pth")
