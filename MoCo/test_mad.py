...
LastEditors: Creling
LastEditTime: 2022-08-24 17:49:07
...
if dataset == 'cifar10':
    ...
    n_classes = 10
    tmp_set = torchvision.datasets.STL10(root="/home/lipan/LiPan/dataset/", split='train', download=True, transform=test_transform)
...
if dataset == 'gtsrb':
    n_classes = 43
    tmp_set = test_data = torchvision.datasets.GTSRB(root="/home/lipan/LiPan/dataset/", split='test', download=True, transform=test_transform)
...
sd = torch.load(f'./results/moco-downstream.pth')
# 
